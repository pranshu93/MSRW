...
list_files=(
            bb_3class_winlen_256_winindex_all
            bb_3class_winlen_384_winindex_all
            bb_3class_winlen_512_winindex_all
            bb_3class_winlen_640_winindex_all
            bb_3class_winlen_768_winindex_all
            )
...
sh ../hpc_scripts/2_create_batch_jobs.sh "rerun_3class_tar_winindex_all" "02:00:00" slurm
