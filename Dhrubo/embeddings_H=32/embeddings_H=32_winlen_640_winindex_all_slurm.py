...
base='/scratch/dr2915/Bumblebee/bb_3class_winlen_' + str(winlen) + '_winindex_all/' \
     'HumanVsNonhuman_48_16/embedding_H=32_k=38_ep=10_it=10_rnd=10'
...
import hpc_scripts.gridsearch_emiembeddings_H_32

# Rename file to avoid confusion, change prefix
os.rename(jobfolder + 'embedding.sh', jobfolder + 'embedding_H=32_winlen=' + str(winlen) + '.sh')
prefix='embedding_H=32_winlen=' + str(winlen)
