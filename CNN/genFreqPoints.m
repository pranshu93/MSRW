...
data_neg = 'C:\Users\Sangeeta\Desktop\MATLAB_Scripts\Data_Repository\Bike_Human\bikes_first_window_start'; % num2str(num)];
data_pos = 'C:\Users\Sangeeta\Desktop\MATLAB_Scripts\Data_Repository\Bike_Human\humans_first_window_start'; % num2str(num)];
train_data = [];
