...
# Overall parameter space (reduced) #
...
D=(2 3)
S=(1.0)
lW=(0.00001 0.0001 0.01)
lV=(0.00001 0.0001 0.01)
lT=(0.00001 0.0001 0.01)
lZ=(0.000001 0.0001 0.001)
sZ=(0.1 0.2)
                    ...
                    do
                        ...
                        do
                            ...
                            do
                                for r in `seq 1 5`;
                                do
                                    echo python3 ../Architecture/dynamic_rnn_bonsai.py -base $1 -ct 1 -w 32 -sp 0.5 -lr 0.005 -bs 128 -hs 16 -ot 0 -ml 768 -fn $r -P $i -dep $j -sig $k -rW $l -rV $m -rT $n -rZ $o -sZ $p -out '$outname'
                                done
                            done
                        done
                    done
